...
test.describe('User Registration', () => {
  ...
  test('should show validation error for invalid email', async ({ page, testUser }) => {
    await page.goto('/register')
  ...
  test('should show validation error for short password', async ({ page, testUser }) => {
    await page.goto('/register')
...
test.describe('User Login', () => {
  test('should login with valid credentials', async ({ page, testUser }) => {
    ...
    // Verify user greeting is displayed in the welcome heading
    await expect(page.getByRole('heading', { name: new RegExp(`welcome back.*${testUser.firstName}`, 'i') })).toBeVisible({ timeout: 10000 })
  })
